        ...
        return (
          <div className="actions flex gap-3 items-center h-full">
            <button
              ...
              className="rounded-xl w-24 h-10 cursor-pointer bg-gray-500 flex items-center justify-center"
            >
              Edit
            </button>
            <button
              onClick={() => deleteMember(params.id)}
              className="rounded-xl w-24 h-10 cursor-pointer bg-red-400 flex items-center justify-center"
            >
              Delete
            </button>
          </div>
